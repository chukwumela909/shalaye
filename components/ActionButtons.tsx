...
export default function ActionButtons({ 
  ...
  return (
    <div className="mt-6 space-y-3">
      <p className="text-[#F0F3F7] text-sm text-center mb-4">
        Ready to proceed? Contact us directly:
      </p>
      ...
      <p className="text-[#8A919E] text-xs text-center">
        Pre-filled message will include your calculation details
      </p>
    </div>
  );
}
